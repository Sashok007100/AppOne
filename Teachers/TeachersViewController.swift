...
class TeachersViewController: UIViewController {
    ...
    private lazy var oneSemestr = ["Алгебра и геометрия", "Введение в программную инженерию", "Иностранный язык",
                      "Информатика", "История", "Математический анализ",
                      "Процедурное программирование","Физика", "Физическая культура и спорт"]
    
    private lazy var twoSemestr = ["Алгебра и геометрия", "Анализ сложности алгоритмов", "Дискретная математика",
    ...
    private lazy var threeSemestr = ["Иностранный язык", "Математическая логикаи теория автоматов", "Математический анализ",
    ...
    private lazy var fourSemestr = ["Архитектура вычислительных машин и систем", "Иностранный язык", "Информационные системы и технологии",
    ...
    private lazy var fiveSemestr = ["Архитектура вычислительных машин и систем", "Безопасность жизнедеятельности", "Информационные системы и технологии",
                       "Компьютерная графика", "Основы сетевых технологий", "Проектирование и разработка баз данных",
                       "Разработка клиент-серверных приложений", "Системная и программная инженерия", "Теория автоматов и формальных языков",
                       "Физическая культура и спорт"]
    
    private lazy var sixSemestr = ["Гражданская оборона", "Интелектуальные информационные системы", "Компьютерная графика",
    ...
    private lazy var sevenSemestr = ["Архитектура программных продуктов", "Имитационное моделирование инофрмационных систем", "Инженерно-техническая лексика",
    ...
    private lazy var eightSemestr = ["Архитектура программных продуктов", "Выпускная квалификационная работа", "Государственный экзамен",
